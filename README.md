...
Face Recognition using PCA (Eigen Faces) and LDA algorithms using The ORL face database.
...
## Prequisites
```bash
pip3 install cupy numpy pandas glob matplotlib sklearn opencv-python
...
```bash
jupyter-notebook Eigenfaces_Notebook_FINAL.ipynb
```
